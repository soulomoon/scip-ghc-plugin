...
`ContextInfo` is defined in `Ext.Types`, and looks like
...
enrichHie ts (hsGrp, imports, exports, docs) ev_bs insts tcs tte =
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
In Ext.Ast we decorate every node in the AST with its
